    ...
    >
      <div className={`container mx-auto px-6 transition-all duration-800 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="space-y-8">
                ...
                <Card className="backdrop-blur-lg bg-white/10 border-white/20 shadow-2xl shadow-blue-500/20 p-6 transition-all duration-300 hover:shadow-blue-500/30 h-full">
                  <div className="space-y-4">
                    ...
                    <p className="text-white/80">
                      Where I learned the value of building things with my own hands, my path started with technical education and gradually evolved into the world of technology through self-learning, real-world projects, and freelancing. Along the way, I worked as a web developer and a data entry specialist, gaining practical experience in problem solving, communication, and delivering reliable solutions.
                      <br /><br />
                      Later, I founded my own brand, Ronaq, where I combined technology, design, and entrepreneurship to create real products and manage an end-to-end business, from idea and production to customer experience and growth.
                      <br /><br />
                      Today, I continue to grow as an aspiring Software Engineer, driven by a clear mission: to use technology as a tool for empowerment, learning, and creating meaningful impact, for myself, for my community, and for others around the world. 
                    </p>
                  </div>
                </Card>
              </div>
            ...
            {/* Bottom Row - My Values Card - Full Width */}
            <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {[
                      ...
                      <div 
                        key={value.title} 
                        className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-lg p-4 hover:bg-white/10 transition-colors duration-300 h-full"
                      >
